...
Two-to-three page executive brief (Markdown source + branded PDF) for systems-integrator and agency leadership.
...
- `executive-value-brief.md` — export-ready Markdown following the Cognition white-paper structure
- `Cognition-FPPS-HCM-Executive-Value-Brief.pdf` — branded PDF built from the Markdown
- `diagrams/` — value-chain and responsibility-split figures
