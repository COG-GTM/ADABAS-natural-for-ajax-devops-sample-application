...
|---|---|---|---|---|
| 00 | [`00-executive-value-brief/`](00-executive-value-brief/) | Executive value brief (Markdown master + branded [PDF](00-executive-value-brief/Cognition-FPPS-HCM-Executive-Value-Brief.pdf)) and the single-page [methodology overview](00-executive-value-brief/methodology-overview.html) (self-contained HTML, Cognition × SMX × DOI) | Gives program leadership the positioning, scope split, proof points, and honest maturity statement needed to sponsor the approach | Everything below; [`docs/concurrency-refactor.md`](../docs/concurrency-refactor.md) |
