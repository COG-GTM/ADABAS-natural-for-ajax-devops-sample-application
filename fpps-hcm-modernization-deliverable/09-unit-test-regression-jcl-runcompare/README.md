...
| **Builds on** | `../../tests/` (140 tests), `../../.github/workflows/regression-tests.yml`, `../../.github/workflows/codeql-analysis.yml`, `../../docs/testing-and-ci.md`, `../08-equivalence-testing-reconciliation/harness/` |
...
flowchart LR
    ...
    S1 --> S2["Step 2<br/>python3 -m unittest discover -s tests -v<br/>140 tests: 67 behavioural · 22 source-conformance · 47 evidence-drift · 4 package-integrity"]
